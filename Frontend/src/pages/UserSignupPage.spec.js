...
describe('UserSignupPage', () => {
    describe('Layout', () => {
        ...
        it('has input for Confirm Password', () => {
            const { queryByPlaceholderText } = render(<UserSignupPage />);
            const displayNameInput = queryByPlaceholderText('Your display Confirm Password');
            expect(displayNameInput).toBeInTheDocument();
        })

        it('has input for Confirm Password type password', () => {
            const { queryByPlaceholderText } = render(<UserSignupPage />);
            const confirmPasswordInput = queryByPlaceholderText('Your display Confirm Password');
    ...
    describe('Interactions', () => {
        ...
        const setupForSubmit = (props) => {
            ...
            confirmPasswordInput = queryByPlaceholderText('Your display Confirm Password');
